...
void TravellingSalesman::createPopulation() {
    ...
    tspChildren = std::vector<TSPRoute>(populationSize, TSPRoute(length, xPoints, yPoints));
    tspParents = std::vector<TSPRoute>(populationSize, TSPRoute(length, xPoints, yPoints));
